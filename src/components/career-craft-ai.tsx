...
} from "@/ai/flows/generate-message";
...
const formSchema = z.object({
  messageType: z
    .string()
    .nonempty({ message: "Please select a message type." }),
  goal: z.string().min(10, {
    message: "Please describe your goal in at least 10 characters.",
  }),
  keyPoints: z.string().min(10, {
    message: "Please provide at least 10 characters of key points.",
  }),
...
const MessagePreview = ({
  ...
  const renderContent = () => {
    const cardClassName =
      "p-4 my-2 font-sans text-sm bg-card/60 border-accent/20 backdrop-blur-sm";
    ...
    switch (type) {
        ...
        return (
          <div className="p-4 my-2 flex items-start gap-3">
            <Avatar>
              ...
              />
              <AvatarFallback>
                {(yourName || "A").charAt(0).toUpperCase()}
              </AvatarFallback>
            </Avatar>
      ...
      case "Cover Letter Paragraph":
        return (
          <Card
            className={`${cardClassName} font-serif text-base border-dashed border-accent/40`}
          >
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "The AI could not generate a message. Please check your inputs and try again.",
      });
    } finally {
      setIsLoading(false);
    }
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Resume Bullet Point">
                            Resume Bullet Point
                          </SelectItem>
                          <SelectItem value="Cover Letter Paragraph">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g., Request a promotion from my manager"
                          {...field}
                          disabled={isLoading || isSuggesting}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Professional & Formal">
                            Professional & Formal
                          </SelectItem>
                          <SelectItem value="Enthusiastic & Friendly">
                            Enthusiastic & Friendly
                          </SelectItem>
                          <SelectItem value="Concise & Direct">
                            Concise & Direct
                          </SelectItem>
                          <SelectItem value="Confident & Assertive">
                            Confident & Assertive
                          </SelectItem>
                          <SelectItem value="Grateful & Appreciative">
                ...
                <Accordion
                  type="single"
                  collapsible
                  className="w-full border-b-accent/20"
                >
                    ...
                    <AccordionContent className="pt-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder="e.g., The Hiring Team"
                                  {...field}
                                  disabled={isLoading || isSuggesting}
                                  className="bg-background"
                                />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Sign-off (Optional)</FormLabel>
                              <FormControl>
                                <Input
              ...
              <CardFooter className="flex flex-col sm:flex-row justify-between gap-4 p-0 pt-4">
                ...
                <Button
                  type="submit"
                  disabled={isLoading || isSuggesting}
                  className="w-full sm:w-auto font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-accent/40"
                >
                  <Sparkles
                    className={`mr-2 h-4 w-4 ${
