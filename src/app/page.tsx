...
export default function Home() {
  return (
    <div className="flex flex-col items-center p-4 sm:p-6 md:p-8">
      {/* Hero Section */}
      <section className="w-full max-w-3xl text-center mb-12 animate-fade-up">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            <li className="bg-card/80 border border-accent/20 rounded-xl p-4 shadow-sm">
          ...
          <div className="w-full flex justify-center">
            <span className="inline-block bg-primary/10 text-primary px-6 py-3 rounded-full text-base font-semibold border border-accent/20 mt-4 shadow-md">
